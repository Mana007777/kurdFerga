<div class="p-6 md:p-10 max-w-5xl mx-auto w-full">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-slate-500 dark:text-gray-400 mt-1">Videos for <span class="font-bold">"{{ $playlist->title }}"</span>.</p>
        </div>
    </div>
    ...
    <div class="space-y-6">
        ...
        @empty
            <div class="text-center py-12 glass-panel rounded-2xl border border-dashed border-slate-300 dark:border-gray-700">
                ...
                <h3 class="text-lg font-bold text-slate-700 dark:text-gray-300">No Sections Yet</h3>
