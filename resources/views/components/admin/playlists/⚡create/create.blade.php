<div class="p-6 md:p-10 max-w-4xl mx-auto w-full">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-black text-slate-800 dark:text-white tracking-tight">Create Playlist</h1>
                <p class="text-slate-500 dark:text-gray-400 mt-1">Publish a new learning module to the curriculum.</p>
            </div>
        </div>
