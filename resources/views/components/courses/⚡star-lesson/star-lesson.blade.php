<div>
    <button
        wire:click.stop="toggleStar"
        @class([
            'p-1.5 rounded-lg transition-all duration-200',
            'text-amber-500 bg-amber-500/10 hover:bg-amber-500/20' => $isStarred,
            'text-slate-400 hover:text-amber-500 hover:bg-amber-500/10' => ! $isStarred,
        ])
        title="{{ $isStarred ? 'Unstar video' : 'Star video' }}"
    >
        <svg
            @class([
                'w-4 h-4',
