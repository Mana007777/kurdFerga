<div class="inline-flex items-center">
    <button
        ...
        @class([
            ...
            'bg-slate-100 text-slate-500 border-slate-200 dark:bg-gray-800 dark:text-gray-400 dark:border-white/5 hover:bg-violet-500 hover:text-white hover:border-violet-500' => ! $isStarred,
        ])
    >
        <svg
            @class([
