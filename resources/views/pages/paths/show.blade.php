...
<div class="px-8 md:px-12 py-12 max-w-7xl mx-auto w-full space-y-20">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('paths.index') }}" wire:navigate class="px-3 py-1.5 rounded-lg bg-zinc-950 border border-zinc-800 text-[10px] font-black text-zinc-500 uppercase tracking-widest hover:border-violet-500/50 hover:text-violet-400 transition-all">
            [SYS::PATHS]
        </a>
                ...
                <div class="bg-black border border-zinc-800 rounded-[2.5rem] p-10 relative group overflow-hidden">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach($roadmapData['technologies'] as $tech)
                            <span class="px-4 py-2 rounded-xl bg-zinc-950 border border-zinc-800 text-[10px] font-black text-zinc-400 uppercase tracking-widest hover:border-emerald-500/50 hover:text-emerald-400 transition-all">
                                {{ $tech }}
                            </span>
                        @endforeach
                    </div>
                    ...
                    @if($index % 2 === 0)
                        ...
                        <div class="md:w-1/2 md:pr-24 w-full md:text-right space-y-4">
                            ...
                            <div class="flex items-center gap-2 justify-start md:justify-end">
                                <span class="px-3 py-1 rounded bg-zinc-950 border border-zinc-800 text-[8px] font-black text-zinc-400 uppercase tracking-[0.2em]">
