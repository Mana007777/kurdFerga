            ...
            @if(isset($topUsers[1]))
                <div class="order-2 md:order-1 flex flex-col items-center w-full md:w-64 group">
                    <div class="relative mb-6">
                        ...
                        <div class="absolute -bottom-2 -right-2 w-8 h-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 font-mono font-black text-xs shadow-lg">02</div>
                    </div>
